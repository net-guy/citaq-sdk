...
public class USBConnectUtil{
	...
	private USBConnectUtil(int type) {
        mUSBType = type;
    }
    
    public static USBConnectUtil getInstance(int type) {
        return new USBConnectUtil(type);
    }
    ...
    public void init(Context context) { 
        ...
        context.registerReceiver(mUsbDeviceReceiver, usbFilter);
        
        openUSBPrinter(context);
    }
     ...
     * Enumerate Device
     */
    public boolean enumerateDevice(Context context) {
        if (mUsbManager == null) {
            return false;
        }
